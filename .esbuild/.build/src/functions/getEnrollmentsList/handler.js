...
// src/functions/getEnrollmentsList/handler.ts
__export(exports, {
  main: () => main
});
...
var getEnrollmentsList = async () => {
  ...
  try {
    ...
    return formatJSONResponse({
      message: "List of the enrollments",
      enrollments
    });
  } catch (error) {
    return formatJSONResponse({
...
var main = middyfy(getEnrollmentsList);
